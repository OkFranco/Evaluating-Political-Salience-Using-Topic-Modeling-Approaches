...
#SBATCH --job-name=topification_tweets_top2vec_doc2vec_bi
...
echo "Topification_tweets_top2vec_doc2vec_bi.py"
python3.10 Topification_tweets_top2vec_doc2vec_bi.py
