...
collect_load_idxs_to_compare="read"
...
idx_to_keep_final_aux=read_files_in_directory(file_path_idxs+'/'+directory_child_idx_to_keep.title())
idx_to_keep_final=pd.concat(idx_to_keep_final_aux,axis=0).iloc[:,-1].tolist()

all_idx_combinations_aux=read_files_in_directory(file_path_idxs+'/'+directory_child_all_idx_combinations.title())
all_idx_combinations_aux2=pd.concat(all_idx_combinations_aux,axis=0)
all_idx_combinations=list(all_idx_combinations_aux2.iloc[:,-1].unique())+list((all_idx_combinations_aux2.iloc[:,-2].unique()))
