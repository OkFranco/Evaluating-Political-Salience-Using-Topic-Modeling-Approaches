...
#SBATCH --job-name=topification_parliament_top2vec_use_bi
...
echo "Topification_parliament_top2vec_use_bi.py"
python3.10 Topification_parliament_top2vec_use_bi.py
