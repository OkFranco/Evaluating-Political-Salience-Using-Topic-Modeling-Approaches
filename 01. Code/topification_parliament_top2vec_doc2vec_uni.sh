...
#SBATCH --job-name=topification_parliament_top2vec_doc2vec_uni
...
echo "Topification_parliament_top2vec_doc2vec_uni.py"
python3.10 Topification_parliament_top2vec_doc2vec_uni.py
