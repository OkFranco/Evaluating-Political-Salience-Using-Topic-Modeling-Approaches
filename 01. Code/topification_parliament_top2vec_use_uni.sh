...
#SBATCH --job-name=topification_parliament_top2vec_use_uni
...
echo "Topification_parliament_top2vec_use_uni.py"
python3.10 Topification_parliament_top2vec_use_uni.py
