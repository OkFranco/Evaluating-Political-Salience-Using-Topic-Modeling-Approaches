...
#SBATCH --job-name=topification_tweets_top2vec_doc2vec_uni
...
echo "Topification_tweets_top2vec_doc2vec_uni.py"
python3.10 Topification_tweets_top2vec_doc2vec_uni.py
